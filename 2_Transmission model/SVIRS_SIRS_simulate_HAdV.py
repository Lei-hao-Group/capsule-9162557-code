...
# Parameters from HAdV SIRS model (Pathogen 2)
beta2 = 2.733323
mu2 = 0.944679  
xi2 = 0.008652  
...
try:
    ...
    # Pathogen 2 (HAdV) 
    hadv_start_row = df[(df['Year'] == 2023) & (df['Week'] == 52)].iloc[0]
    I2_0_fitted = hadv_start_row['Weekly_HADV_Positive_Rate'] / 1000
    print(f"HAdV I0 (2023-W52) read from data: {I2_0_fitted:.6f}")
...
output_filename = 'heatmap_14comp_abs_ratio_inf_hadv_step001.csv'
...
if np.any(np.isfinite(plot_data_log10)):
    ...
    # --- Plot HAdV data point as "米" shape ---
    marker_lambda = 0.748  
    marker_theta2 = 1.128135  
    ...
    # Add the text label
    ax.text(marker_lambda + 0.015, marker_theta2, 'HAdV',  
            ha='left', 
            va='center', 
            color='black', 
            fontsize=24,
...
plt.tight_layout()
plt.savefig("heatmap_14comp_abs_ratio_inf_hadv_step001.png") 
plt.show()

print("\nScript finished. Heatmap plot saved as 'heatmap_14comp_abs_ratio_inf_hadv_step001.png'") 